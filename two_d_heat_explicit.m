...
%2nd order explicit FD scheme, central in space in x and y
...
%constant mu in x    %%NOTE Vx+Vx<= 1/2 for stability
Vx = dt/(dx^2);
...
%%%%Add in Boundary Conditions%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    zlabel('u(x,y,t)')
    %zlim([0, 2.5])
    title(['Explicit Sol 2D Heat Eq. , dt = '...
